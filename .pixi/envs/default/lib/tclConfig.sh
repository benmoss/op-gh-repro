...
# installed.
TCL_PREFIX='/private/tmp/cool/.pixi/envs/default'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/private/tmp/cool/.pixi/envs/default'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /private/tmp/cool/.pixi/envs/default/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/tk_1699201850000/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/private/tmp/cool/.pixi/envs/default=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /private/tmp/cool/.pixi/envs/default/include -mmacosx-version-min=11.0 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/private/tmp/cool/.pixi/envs/default/lib -L/private/tmp/cool/.pixi/envs/default/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/private/tmp/cool/.pixi/envs/default/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/private/tmp/cool/.pixi/envs/default/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/private/tmp/cool/.pixi/envs/default/include'
...
# compiled.
TCL_SRC_DIR='/private/tmp/cool/.pixi/envs/default/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/private/tmp/cool/.pixi/envs/default/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/private/tmp/cool/.pixi/envs/default/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/private/tmp/cool/.pixi/envs/default/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/private/tmp/cool/.pixi/envs/default/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/private/tmp/cool/.pixi/envs/default/lib/libtclstub8.6.a'
